...
Public Class BtnViewLog
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            Dim aoi As Aoi = BA_LoadHRUFromXml(folderPath)
            If aoi IsNot Nothing Then
                If aoi.ApplicationVersion <> hruExt.version Then
                    MessageBox.Show("This Hru log was created using an older version of BAGIS-H. It may not display correctly", "Old version", MessageBoxButtons.OK, MessageBoxIcon.Information)
                End If
                Dim filePath As String = BA_StandardizePathString(folderPath, False) & BA_EnumDescription(PublicPath.HruHtmlFile)
                BA_WriteHtmlFile(aoi, filePath, True)
