...
Public Class ReclassContinuousRule
    ...
    Sub New(ByVal layerName As String, ByVal reclassField As String, _
            ByVal reclassItems As ReclassItem(), ByVal inputFolderPath As String, ByVal id As Integer)
        MyBase.New()
        m_inputLayerName = layerName
        m_ruleType = HruRuleType.RasterReclassContinuous
